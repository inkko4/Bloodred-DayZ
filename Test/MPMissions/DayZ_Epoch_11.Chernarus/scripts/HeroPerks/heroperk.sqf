...
if (_isHero) then {
	...
	if (_isAwesomeHero) then {
		...
		*/
		player setVariable ["HeroPerk",1,true];
		titleText ["Thanks for being a nice guy! Vehicle Scroll option added to use at your convenience!", "PLAIN DOWN", 3];
	};
	if (_isEpicHero) then {
		/*
		...
		clearWeaponCargo _object;
		*/
		player setVariable ["HeroPerk",2,true];
		titleText ["Thanks for being a nice guy! Vehicle Scroll option added to use at your convenience!", "PLAIN DOWN", 3];
	};
	if (_isPerfectHero) then {
		...
		*/
		player setVariable ["HeroPerk",3,true];
		titleText ["Thanks for being a nice guy! Vehicle Scroll option added to use at your convenience!", "PLAIN DOWN", 3];
		//sleep 240;
		//deleteVehicle _box;
	};	
