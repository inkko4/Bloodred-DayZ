...
/*
			position[]={6326.4805,7809.4888};
;*/
/* You can use USE_CANBUILD or/and (works together) the custom positions below (USE_POSITIONS) [position or zone,radius] 

		[[2205.1836,6216.6533,0],100,true],
        [[12944.227,12766.889,0],100,true],
		[[13441.16,5429.3013,0],100,true],
		[[1606.6443,7803.5156,0],100,true],
        [[12060.471,12638.533,0],100,true],
        [[7989.3354,2900.9946,0],100,true],
        [[13532.614,6355.9497,0],100,true],
        [[4361.4937,2259.9526,0],100,true]*/
waituntil {alive player};
uisleep 60;
_infiSZ =
[
		[[1606.6443,7803.5156,0],100,true],
		[[12944.227,12764.6,0],100,true],
		[[6326.4805,7809.4888,0],100,true],
		[[12060.471,12638.533,0],100,true],
		[[11447.91,11364.536,0],100,true],
		[[4064.2258,11665.938,0],100,true]
];
...
[_infiSZ] spawn {
        ...
        _endSafeZone =
        {
				...
				wild_spawnZombies = 		compile preprocessFileLineNumbers 'scripts\walkers\wild_spawnZombies.sqf';
