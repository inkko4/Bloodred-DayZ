...
BankDialogPlayerBalance2 = 14001;
BankDialogBankBalance = 13002;
BankDialogBankBalance2 = 14002;
...
BankDialogUpdateAmounts2 = {
	ctrlSetText [BankDialogPlayerBalance2, format["%1 %2", (player getVariable ['cashMoney', 0] call BIS_fnc_numberText), CurrencyName]];
	ctrlSetText [BankDialogBankBalance2, format["%1 %2", (profileNamespace getVariable 'atmBank' call BIS_fnc_numberText), CurrencyName]];
};
BankDialogWithdrawAmount2 = {
	...
	if(_amount > 2000000) exitWith { cutText ["You can not withdraw more then 2,000,000 coins at once.", "PLAIN DOWN"]; };
	...
	profileNamespace setVariable ["atmBank",_newbank];
	player setVariable ["atmBank2",_newbank,true];
...
BankDialogDepositAmount2 = {
	...
	if(_amount > 2000000) exitWith { cutText ["You can not deposit more then 2,000,000 coins at once.", "PLAIN DOWN"]; };
