...
//       };
	...
	_combatlog = {
		 if (_altState) then {
			systemchat "You shouldn't have done that...";
			player setdamage 1;
		 };
		 _handled = true;
	};
    ...
    [[DIK_0], _groupmenu] call _addArray;
    [[DIK_5], _earplug] call _addArray;
    [[DIK_6], _debugmonitor] call _addArray;
    //[[DIK_7], _playdead] call _addArray;
    [[DIK_F4], _combatlog] call _addArray;
...
//  [[DIK_NUMPAD9], _rotate_right] call _addArray;
    ...
    [[  DIK_F9, DIK_F10, DIK_F11, 
        ...
        DIK_F3,DIK_F2,DIK_F1,
        DIK_4], _block] call _addArray;
