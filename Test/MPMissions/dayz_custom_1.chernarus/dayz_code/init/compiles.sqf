...
//	"filmic" setToneMappingParams [0.153, 0.357, 0.231, 0.1573, 0.011, 3.750, 6, 4]; setToneMapping "Filmic";
	...
	player_zombieCheck = compile preprocessFileLineNumbers "dayz_code\compile\player_zombieCheck.sqf";	//Run on a players computer, checks if the player is near a zombie
	...
	fnc_usec_unconscious = compile preprocessFileLineNumbers "dayz_code\compile\fn_unconscious.sqf";
	...
	player_zombieSwarmAttack = compile preprocessFileLineNumbers "dayz_code\compile\player_zombieSwarmAttack.sqf";
	...
	zombie_generate = compile preprocessFileLineNumbers "dayz_code\compile\zombie_generate.sqf";			//Server compile, used for loiter behaviours
	...
	call                             compile preprocessFileLineNumbers "p2_debug\fn_hintMsg.sqf";                                
    fnc_p2debugMonColorGUI =         compile preprocessFileLineNumbers "p2_debug\fnc_debugMonColourGUI.sqf";
    call                             compile preprocessFileLineNumbers "p2_debug\fnc_debugMon.sqf";
	
	[] spawn {
		waitUntil {!isNil 'fnc_debugMon'};
		[] call fnc_debugMon;
	};
...
zombie_initialize = compile preprocessFileLineNumbers "dayz_code\compile\zombie_initialize.sqf";
...
dayz_zombieSpeak = compile preprocessFileLineNumbers "dayz_code\compile\object_speak.sqf";			//Used to generate random speech for a unit
