class CfgCrafting {
	...
	//Custom
	#include "Recipes\Ammo\M9ammo.hpp"
	#include "Recipes\Ammo\Makarovammo.hpp"
	#include "Recipes\Ammo\mp5ammo.hpp"
	#include "Recipes\Ammo\Stanag.hpp"
	#include "Recipes\Ammo\Bizonammo.hpp"
	#include "Recipes\Ammo\akammo.hpp"
	#include "Recipes\Build\tent.hpp"
};
