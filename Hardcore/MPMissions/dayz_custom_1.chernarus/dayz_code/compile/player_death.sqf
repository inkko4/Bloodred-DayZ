...
1 cutRsc ["DeathImage_DZ","BLACK OUT",200];

sleep 2;

for  "_x" from 30 to 1 step -1 do {
	titleText [format ["You will abort to lobby in %1", _x], "PLAIN DOWN", 1];
	sleep 1;
};
